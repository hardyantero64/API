 ...
 */
class getHeroesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HeroesRepository' shared autowired service.
     *
     * @return \App\Repository\HeroesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HeroesRepository.php';

        return $container->privates['App\\Repository\\HeroesRepository'] = new \App\Repository\HeroesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
